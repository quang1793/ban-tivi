...
url_tivi = "http://127.0.0.1:5008/tivi/danh_sach-tivi"
# Xử lý Lưu trữ 

def Doc_danh_sach_tivi_tu_api():
    urlResponse = urllib.request.urlopen(url_tivi)
    DanhSachTivi = json.loads(urlResponse.read().decode("utf-8","replace"))
    return DanhSachTivi['danh_sach_tivi']
...
def Tao_Chuoi_HTML_Danh_sach_Tivi(Danh_sach_Tivi):
    ...
    for Tivi in Danh_sach_Tivi:
        ...
        Chuoi_Hinh_to='<img  style="width:300px"  src="'+ url_for('static', filename = Tivi["Ma_so"]+'.png') + '" />'
        ...
        Chuoi_Thong_tin='<div class="btn" style="text-align:left">' + \
                ...
                '<a data-toggle="modal" href="#'+Tivi["Ma_so"]+'">Xem chi tiết</a></div>'
        ...
        <div class="modal fade" id="'''+Tivi["Ma_so"]+'''">
        ...
        '''        
        Chuoi_HTML ='<div class="col-md-4" >' + Chuoi_Hinh_nho + Chuoi_Thong_tin + Chuoi_Xem_tivi + '</div>' 
